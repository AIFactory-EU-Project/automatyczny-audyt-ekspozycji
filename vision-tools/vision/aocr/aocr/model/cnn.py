...
class CNN(object):
    ...
    def __init__(self, input_tensor, is_training, dropout):
        self._build_network(input_tensor, is_training, 1.0-dropout)

    def _build_network(self, input_tensor, is_training, keep_prob):
        """
        ...
        net = dropout(net, is_training, keep_prob)
